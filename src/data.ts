import { Profile, GlossaryTerm, Counterparty } from "./types";
...
export const mockCounterpartiesByRole: Record<'director' | 'accountant', Counterparty[]> = {
  director: [
    {
      id: "cnt-dir-1",
      name: "ООО 'МинскОптРеклама'",
      unp: "193456789",
      iban: "BY92BPSB30129999999999990000",
      bankName: "ЗАО 'Альфа-Банк'",
      contract: "Договор продвижения и интернет-маркетинга №12-Р от 05.03.2025",
      status: "Активный контрагент",
      balanceContext: "Имеется задолженность контрагента в пользу ООО 'ТехноПром' на сумму 3 200 BYN. Последняя сверка проведена в прошлом месяце."
    },
    {
      id: "cnt-dir-2",
      name: "ОАО 'БелАЗ'",
      unp: "100000010",
      iban: "BY44BPSB30121111111112222222",
      bankName: "ОАО 'Сбер Банк'",
      contract: "Глобальное рамочное соглашение о поставках компонентов №45-В от 12.01.2025",
      status: "Крупнейший стратегический заказчик",
      balanceContext: "Оборот компании с БелАЗом за текущий квартал составил 180 000 BYN. Активная задолженность отсутствует, оплаты всегда поступают вовремя."
    },
    {
      id: "cnt-dir-3",
      name: "ИП Иванов С.И.",
      unp: "190888999",
      iban: "BY12BPSB30128888888888888888",
      bankName: "ОАО 'Сбер Банк'",
      contract: "Договор транспортных услуг и логистической экспедиции №09/25 от 21.02.2025",
      status: "Подрядчик / Перевозчик",
      balanceContext: "Ожидает плановую оплату за транспортные рейсы за май на сумму 1 500 BYN. Срок оплаты по договору — до 25 числа."
    },
    {
      id: "cnt-dir-4",
      name: "ЗАО 'ПоставкаРесурс'",
      unp: "100222333",
      iban: "BY34BPSB30127777777777777777",
      bankName: "ОАО 'Белагропромбанк'",
      contract: "Договор регулярной поставки сырьевых ресурсов №С-88 от 10.11.2024",
      status: "Поставщик сырья",
      balanceContext: "Позавчера ООО 'ТехноПром' провело предоплату на сумму 14 500 BYN за следующую производственную партию (успешно списано и подтверждено выпиской)."
    }
  ],
  accountant: [
    {
      id: "cnt-acc-1",
      name: "ООО 'БизнесСервисРБ'",
      unp: "194444555",
      iban: "BY23BPSB30123333333333333333",
      bankName: "ОАО 'Сбер Банк'",
      contract: "Договор ИТ-аутсорсинга и юридической поддержки №01-Б от 01.01.2026",
      status: "Поставщик услуг",
      balanceContext: "Абонентская плата составляет 850 BYN ежемесячно. Платеж за текущий месяц успешно проведён 1 числа бухгалтером."
    },
    {
      id: "cnt-acc-2",
      name: "ЗАО 'ГарантТранс'",
      unp: "100444555",
      iban: "BY54BPSB30124444444444444444",
      bankName: "ОАО 'Банк Дабрабыт'",
      contract: "Договор долгосрочной аренды складских боксов №АР-12 от 15.08.2024",
      status: "Арендодатель",
      balanceContext: "Ежемесячный арендный платеж в размере 1 200 BYN. Бухгалтеру необходимо провести оплату в срок до 20 июня."
    },
    {
      id: "cnt-acc-3",
      name: "ООО 'ТоргСпецБел'",
      unp: "191234999",
      iban: "BY11BPSB30125555555555555555",
      bankName: "ЗАО 'МТБанк'",
      contract: "Договор разовой поставки офисной техники и канцтоваров №КТ-555 от 10.04.2025",
      status: "Разовый контрагент",
      balanceContext: "Поставка завершена, закрывающие накладные по НСБУ получены, оплачено полностью в размере 920 BYN. Задолженностей нет."
    }
  ]
};
